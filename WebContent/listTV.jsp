			...
			<div class="container">
				...
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=a" role="tab" id="a-tab" aria-controls="a">A</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=b" role="tab" id="b-tab" aria-controls="b">B</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=c" role="tab" id="c-tab"  aria-controls="c">C</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=d" role="tab" id="d-tab"  aria-controls="d">D</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=e" role="tab" id="e-tab"  aria-controls="e">E</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=f" role="tab" id="f-tab"  aria-controls="f">F</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=g" role="tab" id="g-tab"  aria-controls="g">G</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=h" role="tab" id="h-tab"  aria-controls="h">H</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=i" role="tab" id="i-tab"  aria-controls="i">I</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=j" role="tab" id="j-tab"  aria-controls="j">J</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=k" role="tab" id="k-tab"  aria-controls="k">K</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=l" role="tab" id="l-tab"  aria-controls="l">L</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=m" role="tab" id="m-tab"  aria-controls="m">M</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=n" role="tab" id="n-tab"  aria-controls="n">N</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=o" role="tab" id="o-tab"  aria-controls="o">O</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=p" role="tab" id="p-tab"  aria-controls="p">P</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=q" role="tab" id="q-tab"  aria-controls="q">Q</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=r" role="tab" id="r-tab"  aria-controls="r">R</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=s" role="tab" id="s-tab"  aria-controls="s">S</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=t" role="tab" id="t-tab"  aria-controls="t">T</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=u" role="tab" id="u-tab"  aria-controls="u">U</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=v" role="tab" id="v-tab"  aria-controls="v">V</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=w" role="tab" id="w-tab"  aria-controls="w">W</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=x" role="tab" id="x-tab"  aria-controls="x">X</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=y" role="tab" id="y-tab"  aria-controls="y">Y</a></li>
							<li role="presentation"><a href="VideoViewServlet?flag=tv&key=z" role="tab" id="z-tab"  aria-controls="z">Z</a></li>
						</ul>
