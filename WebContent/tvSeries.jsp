...
<!-- general -->
	<div class="general_agileits_genres">
		<h4 class="latest-text w3_latest_text">电视剧</h4>
		<div class="container">
            <div class="agileits-single-top">
				<ol class="breadcrumb">
				  <li><a href="index.html">主页</a></li>
				  <li><a href='TvServlet?flag=moive'>电影列表</a></li>
				</ol>
			</div>
		</div>
		<div class="container">
				...
				<div id="myTabContent" class="tab-content">
					<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
						<div class="w3_agile_featured_movies">
							<c:forEach items="${requestScope.chosenList }" var="itm">
								<div class="col-md-2 w3l-movie-gride-agile">
								<a href="PlayVideoServlet?flag=videoId&videoType=tv&videoId=${itm.tvId }" class="hvr-shutter-out-horizontal">
								<img style="height: 268px;width: 182px;" src="${itm.tvPic }" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="PlayVideoServlet?flag=videoId&videoType=tv&videoId=${itm.tvId }">${itm.tvName }</a></h6>							
									</div>
					...
					<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
						<c:forEach items="${requestScope.playList }" var="itm">
								<div class="col-md-2 w3l-movie-gride-agile">
								<a href="PlayVideoServlet?flag=videoId&videoType=tv&videoId=${itm.tvId }" class="hvr-shutter-out-horizontal">
								<img style="height: 268px;width: 182px;" src="${itm.tvPic }" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
					...
					<div role="tabpanel" class="tab-pane fade" id="rating" aria-labelledby="rating-tab">
						<c:forEach items="${requestScope.scoreList }" var="itm">
								<div class="col-md-2 w3l-movie-gride-agile">
								<a href="PlayVideoServlet?flag=videoId&videoType=tv&videoId=${itm.tvId }" class="hvr-shutter-out-horizontal">
								<img style="height: 268px;width: 182px;" src="${itm.tvPic }" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
...
<!--body wrapper start-->
	<%-- <div class="review-slider">
		 <h4 class="latest-text">电视-系列评论</h4>
			   <div class="container">
					...
					<div id="owl-demo" class="owl-carousel owl-theme">
						<c:forEach items="${requestScope.newList }" var="itm" begin="2" end="10" >
							...
							<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
								<a href="PlayVideoServlet?flag=videoId&videoType=tv&videoId=${itm.tvId }" class="hvr-shutter-out-horizontal"><img src="images/m11.jpg" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
