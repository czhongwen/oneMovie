		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>${moive.moiveName }</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div  id="video">
							 	<video src="${moive.moiveAddress }" class="img-responsive" controls="controls"></video>
							</div>
						</div>
					</div>
						...
						<div class="all-comments-info">
							...
							<div class="agile-info-wthree-box">
								<form action="#" method="get" onsubmit="return comm()">
									...
									<input type="hidden" id="videoId" value="${moive.moiveId}">
				...
				<div class="col-md-4 single-right">
					...
					<div class="single-grid-right">
						...
						<c:if test="${requestScope.listFilmReview==null }">
							<c:forEach items="${requestScope.listMoive }" var="itm" begin="0" end="3">
							<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="PlayVideoServlet?flag=videoId&videoType=moive&videoId=${itm.moiveId }">
								<img style="height: 134px;width: 100px;" src="${itm.moivePic }" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<p><a href="single.html" class="title">电影名称: ${itm.moiveName }</a></p><br>
								...
								<p class="views"><h5>播放量:${itm.moivePlay }</h5></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						</c:forEach>
						...
						<c:if test="${requestScope.listFilmReview!=null }">
							<c:forEach items="${requestScope.listMoive }" var="itm" begin="0" end="8">
							<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="PlayVideoServlet?flag=videoId&videoType=moive&videoId=${itm.moiveId }">
								<img  src="${itm.moivePic }" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<p><a href="single.html" class="title">电影名称: ${itm.moiveName }</a></p><br>
								<p class="author"><h5>国家: <a href="SerachFilmServlet?flag=countryId&countryId=${itm.countryId }" class="author">${itm.countryName }</a></h5></p><br>
			...
			<div class="w3_agile_banner_bottom_grid">
				<div id="owl-demo" class="owl-carousel owl-theme">
					...
					<c:forEach items="${requestScope.listMoive }" var="itm" begin="8" end="15">
						<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							<a href="PlayVideoServlet?flag=videoId&videoType=moive&videoId=${itm.moiveId }" class="hvr-shutter-out-horizontal">
							<img style="height: 244px;width: 183px;" src="${itm.moivePic }" title="album-name" class="img-responsive" alt=" " />
