...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><a href="uploadPic.jsp"><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt=""/></a>后台管理中心</h1>
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="abv.jsp" target="right"><span class="icon-caret-right"></span>首页轮播</a></li>   
